...
class EndUserPortalController extends Controller
{
    ...
    public function ajaxHtml(Request $request)
    {
     ...
     public function show($customer_id, $mailbox_id = null)
     {
         ...
         return view('enduserportal::Projet.showportal', compact('mailbox', 'groupedProjets'));
     }

     //Facturations
 
     public function showfa($id_projet = null, $mailbox_id = null)
     {
         // Traiter l'identifiant de la boîte aux lettres
         $mailbox = $this->processMailboxId($mailbox_id);
         ...
         // Regrouper les facturations par projet si nécessaire
         $groupedFacturations = $facturations->groupBy('id_projet');
     
         // Retourner la vue avec les facturations, les projets, le id_projet et la boîte aux lettres
         return view('enduserportal::Facturations.showportal', compact(
             'mailbox', 
             'facturations', 
             'projets', 
             'id_projet', 
     ...
     public function showInt($id_projet = null, $mailbox_id = null)
     {
         ...
         return view('enduserportal::Interventions.showportal', compact('interventionsDuClient', 'typesinterventions', 'tempsRestantParProjet', 'tempsAlloueParProjet', 'mailbox', 'forfaitHeureParProjet', 'projets'));
     }
