...
// Intervention
Route::get('/interventions/create', 'InterventionController@createForm')->name('interventions.create');
Route::post('/interventions/store', 'InterventionController@store')->name('interventions.store');
// Route::get('/interventions/{id}', 'InterventionController@show')->name('interventions.show');
Route::get('/interventions/{idCustomer}', 'InterventionController@show')->name('interventions.show');



//Projet
Route::get('/projet/create', 'ProjetController@create')->name('projet.createpro');
Route::post('/projet/store', 'ProjetController@store')->name('projet.store');
Route::get('/projet/{id}', 'ProjetController@show')->name('projet.show');


//Facturations
Route::get('/facturations/create', 'FacturationsController@create')->name('Facturations.createFa');
Route::post('/facturations/store', 'FacturationsController@store')->name('Facturations.store');
Route::get('/facturations/{id}', 'FacturationsController@show')->name('Facturations.show');
