...
class Request
{
    ...
    protected function prepareBaseUrl()
    {
        ...
        if ($this->server->has('SCRIPT_NAME') && basename($this->server->get('SCRIPT_NAME')) === $filename) {
            $baseUrl = $this->server->get('SCRIPT_NAME');
        } elseif ($this->server->has('PHP_SELF') && basename($this->server->get('PHP_SELF')) === $filename) {
            $baseUrl = $this->server->get('PHP_SELF');
        } elseif ($this->server->has('ORIG_SCRIPT_NAME') && basename($this->server->get('ORIG_SCRIPT_NAME')) === $filename) {
