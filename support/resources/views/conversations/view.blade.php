        ...
        <div id="conv-layout-header">
            <div id="conv-toolbar">
                ...
                <div class="container-fluid mt-4"> 
                    <form action="{{ route('conversation.update', $conversation->id) }}" method="POST" id="projectForm">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label for="id_projet">Projet :</label>
                            <select name="id_projet" id="projectSelector" onchange="document.getElementById('projectForm').submit();">
