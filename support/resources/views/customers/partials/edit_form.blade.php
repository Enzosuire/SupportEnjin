        ...
        <div class="col-xs-12">
            <form class="form-horizontal margin-top" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('company') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        <input id="company" type="text" class="form-control input-sized-lg" name="company" value="{{ old('company', $customer->company) }}" placeholder="{{ __('(optional)') }}" maxlength="255" required>
