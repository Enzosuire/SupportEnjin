                                ...
                                <li class="dropdown {{ \App\Misc\Helper::menuSelectedHtml('manage') }}">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        @if (Auth::user()->isAdmin())
                                            ...
                                            <li class="{{ \App\Misc\Helper::menuSelectedHtml('interventions.show') }}"><a href="{{ route('interventions.show', ['id' => Auth::id()]) }}"> {{ __('Intervention') }}</a></li>                                     
                                            <li class="{{ \App\Misc\Helper::menuSelectedHtml('projet.show') }}"><a href="{{ route('projet.show', ['id' => Auth::id()]) }}"> {{ __('Projet') }}</a></li>                                       
                                            <li class="{{ \App\Misc\Helper::menuSelectedHtml('Facturations.show') }}"><a href="{{ route('Facturations.show', ['id' => Auth::id()]) }}"> {{ __('Facturation') }}</a></li>                                       
                                         @endif
