...
<div class="container">
    ...
    <div id="users-list" class="card-list margin-top">
        @foreach ($users as $user)
            <div class="card hover-shade @if ($user->invite_state != App\User::INVITE_STATE_ACTIVATED) card-inactive @endif">
                @if ($user->isAdmin())
                ...
                @endif
                <a href="{{ route('users.profile', ['id'=>$user->id]) }}" class="bouton-modif-profil">
