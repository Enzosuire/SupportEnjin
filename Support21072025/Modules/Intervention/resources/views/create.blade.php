        ...
        <form action="{{ route('intervention.store') }}" method="post" class="form-creation">
            ...
            <div class="form-line-2 ">
                <div class="form-group form-line-item champ-input-txt">
                    ...
                    <textarea class="form-control" name="description" placeholder="Ex : Correctif champ dynamique formulaire"></textarea>
                </div>
            </div>
            ...
            <div class="form-line-3">
                ...
                <div class="form-group form-line-item-2 champ-input-txt">
                    ...
                    <input class="form-control" type="date" name="date_intervention" required>
                </div>
            ...
            <div class="form-line-4">
                <div class="form-group form-line-item-1 champ-input-txt">
                    ...
                    <input class="form-control" type="number" name="temps_alloue" placeholder="Ex : 50" required>
                </div>
                

                <div class="form-group form-line-item-2 champ-input-txt">
                    <label for="numero_ticket_jira">Numéro de ticket jira :</label>
                    <input class="form-control" type="text" name="numero_ticket_jira" placeholder="SUP-30">
                </div>
            </div>
