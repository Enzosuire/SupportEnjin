...
Route::get('/interventions/{id_customers?}/{id_projet?}',['uses' => 'InterventionController@show','middleware' => ['auth']])->name('intervention.show');
...
Route::get('/interventions/update/{customerId}/{type}/{id}', ['uses' => 'InterventionController@update',  'middleware' => ['auth']])->name('intervention.updateint');
...
Route::get('/interventions/delete/{customerId}/{type}/{id}', ['uses' =>  'InterventionController@delete', 'middleware' => ['auth']])->name('intervention.delete');
