...
class CrmController extends Controller
{
            ...
            case 'delete_customer':
                ...
                if (!$response['msg']) {
                    ...
                    if ($customer) {
                        ...
                        $response['redirect_url'] = '/clients';  // URL directe
                    } else {
    ...
    public function ajaxSearch(Request $request)
    {
        ...
        $query = CustomerCustomerField::select('value')
            ->where('customer_field_id', CustomerField::decodeName($custom_field_id))
        ...
        foreach ($customer_fields as $row) {
            ...
            if ($is_multiselect) {
                foreach(CustomerField::explodeMultiselectValue($value) as $value_item) {
