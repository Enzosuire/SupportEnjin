    ...
    <form class="" method="POST" action="{{ $form_action ?? '' }}" id="eup-ticket-form">
        <div id="eup-submit-form-main-area">
            ...
            <div class="alert alert-warning" role="alert">
                <p class="text-center"><strong>== Trame pour le support ==</strong></p>
                <ul>
                    <li><strong>URL de la page d'erreur :</strong> Indiquez l'URL de la page d'erreur de votre site.</li>
                    <li><strong>Navigateur/OS :</strong> Précisez le navigateur et le système d'exploitation utilisés.</li>
                    <li><strong>Description de votre problème :</strong> Décrivez le problème rencontré.</li>
                    <li><strong>Étapes pour reproduire l'erreur :</strong> Listez les étapes à suivre.</li>
                    <li><strong>Message d'erreur (le cas échéant) :</strong> Copiez/collez le message d'erreur ici.</li>
                </ul>
            </div>
