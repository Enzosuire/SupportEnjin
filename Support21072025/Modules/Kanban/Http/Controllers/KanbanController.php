...
class KanbanController extends Controller
{
    ...
    public function getMainConversationsQuery($mailbox_id, $board_id, $params, $group_id = null, $swimlane_id = null)
    {
        ...
        /*if ($params['group_by'] == \Kanban::GROUP_BY_STATUS && $group_id == Conversation::STATUS_CLOSED) {
            ...
            if (!in_array(Conversation::STATUS_CLOSED, $params['filters'][\Kanban::FILTER_BY_STATUS])) {
                $status[] = Conversation::STATUS_CLOSED;
            }
        }*/
        // https://github.com/freescout-helpdesk/freescout/issues/3955
    ...
    public function loadConversationsData($conversations)
    {
        ...
        if (\Module::isActive('tags') || \Module::isActive('customfields')) {
        ...
        // Custom fields are also preloaded via conversations_table.preload_table_data filter.
